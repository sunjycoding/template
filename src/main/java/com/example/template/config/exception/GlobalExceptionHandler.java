...
public class GlobalExceptionHandler {
    ...
    public HttpResult handleAuthenticationException(AuthenticationException e, HttpServletRequest request) {
        log.error("AuthenticationException Exception Occurred", e);
        return HttpResult.error("权限不足，请联系管理员");
    }
